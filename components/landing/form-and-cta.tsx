  ...
  return (
    ...
    >
      <div className="max-w-2xl mx-auto flex flex-col items-center gap-8">
        ...
        >
          {c.finalTitle}{" "}
          <span style={{ color: "#C9A84C" }}>{c.finalTitleAccent}</span>
        </motion.h2>
        ...
        {c.finalSubheadline && (
          <motion.p
            ...
            whileInView="visible"
            viewport={{ once: true, margin: "-80px" }}
            className="text-base text-slate-400 leading-relaxed max-w-lg text-center"
          >
            {c.finalSubheadline}
          </motion.p>
        )}
        ...
        >
          <Button
            ...
            onClick={() => {
              ...
              trackEvent("cta_click", { location: "final_cta_primary" })
            }}
          >
            {c.finalCta}
          </Button>
        ...
        {c.finalEventCard && (
          <motion.div
            ...
            whileInView="visible"
            viewport={{ once: true, margin: "-80px" }}
            className="rounded-2xl border p-6 w-full max-w-sm text-left flex flex-col gap-2"
            style={{ borderColor: "rgba(201,168,76,0.25)", backgroundColor: "rgba(201,168,76,0.05)" }}
          >
            {c.finalEventCard.map((line, i) => (
              <p key={i} className="text-sm text-slate-300 font-medium">{line}</p>
            ))}
          </motion.div>
        )}
      </div>
