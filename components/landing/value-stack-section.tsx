            ...
            {c.pricingTiers.map((tier, i) => (
              <motion.div
                ...
                variants={prefersReducedMotion ? {} : fadeUpVariants}
                    ...
                    style={
                      tier.highlighted
                        ? { borderColor: "#C9A84C", backgroundColor: "rgba(201,168,76,0.06)" }
                        : { borderColor: "rgb(51,65,85)", backgroundColor: "rgba(30,41,59,0.5)" }
                    }
              >
                <div className="flex flex-col gap-1">
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <Badge
                      ...
                      style={
                        tier.highlighted
                          ? { backgroundColor: "rgba(201,168,76,0.15)", color: "#C9A84C", borderColor: "rgba(201,168,76,0.4)" }
                          : { backgroundColor: "rgb(51,65,85)", color: "rgb(203,213,225)", borderColor: "rgb(71,85,105)" }
                      }
                    >
                      {tier.badge}
                    </Badge>
                ...
                <div className="flex flex-col items-start sm:items-end gap-2 shrink-0">
                  <div className="flex items-baseline gap-2">
                    <span
                      ...
                      style={{ color: tier.highlighted ? "#C9A84C" : "white" }}
                    >
                      {tier.price}
                    </span>
