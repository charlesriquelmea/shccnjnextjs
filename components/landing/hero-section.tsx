...
function TypewriterEffect({ phrases, prefersReducedMotion }: { phrases: string[]; prefersReducedMotion: boolean }) {
...
function MemberBadge({ text, prefersReducedMotion }: { text: string; prefersReducedMotion: boolean }) {
  return (
    <motion.div
    ...
    >
      <div
        className="px-3 py-1.5 rounded-full text-xs font-black tracking-wider text-[#0a0a0a] shadow-lg"
...
function BrowserMockup({ c, prefersReducedMotion }: { c: Copy; prefersReducedMotion: boolean }) {
  ...
  return (
    ...
    >
      {/* Hero card with member badge */}
      <div className="relative rounded-xl border border-slate-700 shadow-2xl overflow-hidden" style={{ transform: "rotate(-2deg)" }}>
        {/* Member badge */}
        <MemberBadge text={c.memberBadgeText} prefersReducedMotion={prefersReducedMotion} />
        ...
        <div className="bg-slate-900 p-5 min-h-55 relative overflow-hidden">
          ...
          <div className="h-10 rounded-lg w-2/3" style={{ backgroundColor: "#C9A84C" }} />
      ...
      >
        ...
        <pre className="text-green-400 leading-relaxed whitespace-pre-wrap break-all text-[10px]">
          {terminalText}
          {terminalLine < c.terminalLines.length && (
            <motion.span
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="flex-1 lg:w-[55%] max-w-2xl">
            ...
            >
              ...
              {/* Price block */}
              <motion.div variants={fadeUpVariants} className="flex items-baseline gap-3 flex-wrap">
