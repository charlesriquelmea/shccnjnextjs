...
export default function HeroUrgencySection({ c, prefersReducedMotion }: HeroUrgencySectionProps) {
  ...
  return (
    <section className="relative w-full  text-[#fafafa] font-sans selection:bg-blue-500/30 overflow-hidden pt-4 pb-24 border-b border-white/5">
        ...
        <div className="mt-20 md:mt-32 space-y-28 md:space-y-40">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              >
                <code className="text-amber-100 text-sm md:text-[15px] leading-relaxed block">
                  {h.mathGreen}
                </code>
              </motion.div>
            </div>
                ...
                <tbody className="divide-y divide-zinc-800/40">
                  {h.tableRows.map((row: string[], rowIndex: number) => (
                    ...
                    >
                      ...
                      <td className="px-8 py-6 text-amber-100 bg-teal-500/4 font-semibold">{row[2]}</td>
                    </motion.tr>
                  ))}
                </tbody>
              </table>
