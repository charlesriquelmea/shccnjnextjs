...
export const eventSchema = {
  ...
  '@type': 'Event',
  name: 'BuildInNextjs - Webinar de Negocios Digitales',
  ...
  organizer: {
    ...
    name: 'BuildInNextjs',
    url: 'https://BuildInNextjs.com',
    logo: 'https://BuildInNextjs.com/logo.png',
  },
  location: {
  ...
  offers: {
    '@type': 'Offer',
    url: 'https://BuildInNextjs.com#form',
    price: '0',
    priceCurrency: 'USD',
...
export const organizationSchema = {
  ...
  sameAs: [
    'https://facebook.com/BuildInNextjs',
    'https://instagram.com/BuildInNextjs',
    'https://linkedin.com/company/BuildInNextjs',
    'https://twitter.com/BuildInNextjs',
  ],
  contactPoint: {
    '@type': 'ContactPoint',
  ...
  itemListElement: [
    {
      ...
      position: 1,
      name: 'Inicio',
      item: 'https://BuildInNextjs.com',
    },
    {
      '@type': 'ListItem',
      position: 2,
      name: 'Webinar',
      item: 'https://BuildInNextjs.com#detalles',
    },
    {
      '@type': 'ListItem',
      position: 3,
      name: 'Registro',
      item: 'https://BuildInNextjs.com#form',
    },
  ],
};
